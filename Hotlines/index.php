	...
	<body class="bg-dark">
		...
		<nav id="topbar" class="navbar navbar-expand-lg navbar-dark fixed-top bg-dark">
			...
			<div class="collapse navbar-collapse" id="navbarSupportedContent">
				<ul class="nav nav-tabs nav-light mr-auto" role="tablist">
					<li class="nav-item">
						<a class="nav-link" style="color:#E2704E;"href="../">Home</a>
					</li>
					<li class="nav-item">
						<a class="nav-link" style="color:#E2704E;"href="../chat.php">Chat</a>
					</li>
					<li class="nav-item">
						<a class="nav-link" style="color:#E2704E;" href="">Hotlines</a>
					</li>
				</ul>
			</div>
		...
		<div class="container" style="margin-top:50px;">
			<div class="jumbotron bg-dark text-center">
				<h1 class="display-4 text-danger">Renascent Munro Treatment Centre</h1>
				<p class="lead text-danger">Address: 356 Dundas St W, Toronto, ON M5T 1G4<br>Hours: Open 24 hours<br>Province: Ontario<br>Phone: (416) 847-6441</p>
				<h1 class="display-4 text-danger"></h1>
				<p class="lead text-danger">Non-profit organization in Toronto, Ontario<br>Address: 10 Trinity Square, Toronto, ON M5G 1B1<br>Hours: Opens 10 a.m. Mon.</p>
			</div>
		</div>
